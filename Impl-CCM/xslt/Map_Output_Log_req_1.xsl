...
<!-- @generated mapFile="xslt/Map_Output_Log_req_1.map" md5sum="c8c3b416d8b650bcb7c1b8bbc7ddf53c" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		Map_Output_Log_req_1.map
*   Map declaration(s):	Map_Output_Log_req_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Impl-CCM/xslt/Map_Output_Log_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Map_Output_Log_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:Map_Output_Log_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:Map_Output_Log_req_1">
    <io6:smo>
      <context>
        <shared>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:Map_Output_Log_req_12">
    <xsl:param name="smo"/>
    <context>
      <shared>
        <xsl:attribute name="xsi:type">
