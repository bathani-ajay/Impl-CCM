...
<!-- @generated mapFile="xslt/Map_Send_Email_Failure_Response_req_1.map" md5sum="680cf8435b3430afcb72be8ae2133deb" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		Map_Send_Email_Failure_Response_req_1.map
*   Map declaration(s):	Map_Send_Email_Failure_Response_req_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Impl-CCM/xslt/Map_Send_Email_Failure_Response_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Map_Send_Email_Failure_Response_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io5:smo" mode="map:Map_Send_Email_Failure_Response_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io5:smo"  mode="map:Map_Send_Email_Failure_Response_req_1">
    <io5:smo>
      <context>
        ...
        <xsl:call-template name="localShared_et_alToShared_259175808">
  ...
  <xsl:template name="map:Map_Send_Email_Failure_Response_req_12">
    <xsl:param name="smo"/>
    <context>
  ...
  <xsl:template name="localShared_et_alToShared_259175808">
